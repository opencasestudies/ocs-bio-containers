...
```{r, eval = FALSE, fig.alt = "Volumes have to be mounted when running an image to have access to outside files such as scripts or data."}
...
::: {.column-margin}
Find alternatives to suggest for these cases.
:::
