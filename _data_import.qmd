...
[Create a branch](https://www.opencasestudies.org/ocs-bio-version-control/#create-a-new-branch-for-this-analysis) so that any changes you make to scripts can be commited and pushed to your remote repository as a pull request later.
