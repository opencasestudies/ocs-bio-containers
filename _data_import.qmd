...
You may want to look for a container that has packages that meets your needs, or you may know the organization name or a partial name of a container image and want to browse images from that organization or with matching names. In those cases, you'll want to search a registery like Docker Hub. Docker Hub isn't the only container registry. ]This article describes additional registries](https://octopus.com/blog/top-8-container-registries).
...
A. Download the analysis scripts in a `.zip` file
B. Set up a new GitHub repository, using the scaffold as a template and clone that repository locally. 

With this second option, you can practice version-controlling an analysis (an additional reproducibility best practice).
...
##### Option A: Download analysis scripts in a .zip file
...
##### Option B: Use a template GitHub repository and clone the new repository locally

This options allows you to practice version-controlling an analysis. 
...
Navigate to the scaffold GitHub repository on your web browser: [https://github.com/opencasestudies/ocs-bio-containers-scaffold](https://github.com/opencasestudies/ocs-bio-containers-scaffold). Click the green "Use this template" button in the top right, and seelct "Create a new repository" option from the dropdown menu. 
