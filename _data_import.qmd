...
At the top of the Docker Hub section, in the search bar, type the name (or part of the name) of container you want to pull in order to search it and pull the image. 


* Click on the "Docker Hub" option in the left side menu.
* Type `bioocs` and several images from the `bioocs` organization will appear as cards. 
...
* Ensure you are on the "Images" tab of Docker Desktop.
