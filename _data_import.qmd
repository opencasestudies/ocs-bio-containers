...
* Line 16 outputs the number of NA values that are in the extracted table by summing the number of TRUEs from the `is.na()` function.
...
* Enter `cd /home/analysis_scripts` and press the return / enter key.
