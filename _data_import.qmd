...
Open your {{< glossary "Command Line Interface (CLI)" display = "command line interface (CLI)" >}} (e.g., Terminal on a Mac).
...
Option B provides an opportunity to practice more advanced {{< glossary "Reproducibility" display="reproducibility" >}} best practices: {{< glossary "Version-controlled" display="version-controlling" >}} an analysis. However, this is merely an a supported alternative rather than a requirement to follow along with this case study.
