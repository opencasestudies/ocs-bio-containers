...
* Have a `preprocessing.R` script that grabs and wrangles the data
* Have an `analysis.R` script with all the visualization steps together
* Have an `run_analysis.sh` script that makes the directories and drives the preprocessing and analysis
